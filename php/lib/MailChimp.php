...
/**
 * Thanks to https://github.com/mailchimp/APIv3-examples/pull/25
 */
...
class MailChimp {
	...
	public function list_add_subscriber(Array $options)
	{
		...
		if (isset($options['interests']) AND $options['interests']) {
			$payload['interest-categories'] = $options['interests'];
		}
